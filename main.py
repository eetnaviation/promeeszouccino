...
def main():
    ...
    pygame.display.set_caption('progeimet zuucy')
    ...
    while splashScreenTimer < 50:
        ...
        DISPLAY.fill((231, 0, 183))
        # fill the start message on the top of the game
        startMessage = font_small.render("Proffesionaalne Tristan", True, (171, 145, 123))
    ...
    while titleScreen:
        ...
        startMessage = font_small.render("/ban", True, (0, 0, 0))
    ...
    while True:
        ...
        for button in buttons:
            ...
            priceDisplay = font_small.render(str(button.price), True, (1,0,0))
            DISPLAY.blit(priceDisplay, (272 + (buttons.index(button)*125), 408))
            levelDisplay = font_20.render('mkm. ' + str(button.level), True, (200,200,200))
        ...
        if dead:
            ...
            deathMessage = font_small.render("noob", True, (0, 0, 0))
